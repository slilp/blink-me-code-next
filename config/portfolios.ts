...
const portfolios: PortfolioList[] = [
  ...
  },
  {
    ...
    git: "https://github.com/slilp/blink-dashboard-stack",
  ...
  },
  {
    ...
    desc: "Start your GO project with features you want.",
    pic: "go-1.png",
    link: "https://blink-go-boilerplate.onrender.com/swagger/index.html#/",
    git: "https://github.com/slilp/blink-go-boilerplate",
    tags: [Tag.GO, Tag.GIN, Tag.GORM, Tag.POSTGRE, Tag.OPEN_API],
    more: "",
    type: PortfolioType.FULL,
    theme: "",
    fromColor: "cyan-500",
    ...
    detail: [
      ...
      },
      {
        ...
        desc: "Example setting gorm and CRUD for 1-Many / Many-Many relations",
        pic: "",
      },
      {
        id: "go-feature-3",
  ...
  },
  {
    ...
    git: "https://github.com/slilp/blink-nest-boilerplate",
    tags: [
      Tag.NEST,
      Tag.NODE,
      Tag.TYPE_ORM,
